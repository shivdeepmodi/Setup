...
select i.instance_name,cast(b.BEGIN_INTERVAL_TIME as date) snapshot_time,a.sql_id, 
       ...
       a.EXECUTIONS_TOTAL EXECUTIONS
           ...
           ,a.OPTIMIZER_COST
           ,a.sql_profile 
  from dba_hist_sqlstat a, dba_hist_snapshot b , gv$instance i
 where a.snap_id=b.snap_id
 and a.sql_id='&&sql_id'
 and i.inst_id = a.instance_number
 and &&clause
 order by 1,2
/

select i.instance_name,trunc(cast(b.BEGIN_INTERVAL_TIME as date)) snapshot_time,a.sql_id, 
       a.plan_hash_value, 
...
--         ,a.OPTIMIZER_COST
 ...
 and a.sql_id='&&sql_id'
 and i.inst_id = a.instance_number
 group by i.instance_name,trunc(cast(b.BEGIN_INTERVAL_TIME as date)) ,a.sql_id, a.plan_hash_value
 order by 1,2
/
set verify on
